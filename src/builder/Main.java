...
import builder.withDirector.Meal;
import builder.withDirector.MealDirector;
import builder.withDirector.VegMealBuilder;
import builder.withoutDirector.Burger;
...
public class Main {
    public static void main(String[] args) {
        ...
        // In GOF book there is director also so we are showing it below here
        //GOF Builder example
