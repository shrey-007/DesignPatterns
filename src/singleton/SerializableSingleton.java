...
public class SerializableSingleton implements Serializable {
     ...
     * When we deserialize the object JVM itself calls the readResolve() method. We overrided this method, so it will return the same instance
     * @return
     */
